...
import 'package:web_admin/views/screens/user_screen.dart';
...
class RouteUri {
  ...
  static const String smss = '/smss/:userId';
  static const String cards = '/cards:userId';
}
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        name: "sms",
        path: RouteUri.smss,
        builder: (context, state) => UserSmsScreen(
      ...
      GoRoute(
        name: "cards",
        path: RouteUri.cards,
        builder: (context, state) => UserCardScreen(
          userId: state.pathParameters["userId"]!,
        ),
      ),
      GoRoute(
