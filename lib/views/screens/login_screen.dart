  ...
  Future<void> _doLoginAsync({
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      Future.delayed(const Duration(seconds: 1), () async {
        ...
        Stream<QuerySnapshot> _usersnapshot = FirebaseFirestore.instance.collection('admin').
        where('username',isEqualTo: _formData.username).where('password',isEqualTo: _formData.password).
        snapshots();

        _usersnapshot.forEach((field) async {
          if(field.size == 0){
            setState(() {
